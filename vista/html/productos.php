    ...
    if ($_SESSION["rol"]=="admin"){
        ...
        <section id="panel-admin">
            ...
            if (isset($productosxid)){
                ...
                ?>
                <form class="form-admin" action="index.php?action=editarProductoxid" method="post" required enctype="multipart/form-data">
                ...
                ?>
                <form class="form-admin" action="index.php?action=guardarProducto" method="post" required required enctype="multipart/form-data">
                ...
                <tbody>
                    ...
                    while ($fila=$productos->fetch_assoc()){
                        ...
                        <tr>
                            ...
                            <a href="index.php?action=eliminarProducto&id=<?php echo $fila['id_producto']; ?>" onclick="return confirm('¿Estás seguro de que quieres eliminar este producto?');"><button type="button">Eliminar</button></a>
